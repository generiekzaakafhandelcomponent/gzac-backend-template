...
repositories {
    maven {
        url = uri("https://valtimo-releases.s3.eu-central-1.amazonaws.com/")
        content { includeGroupAndSubgroups("com.ritense") }
        mavenContent { releasesOnly() }
    }
    maven {
        url = uri("https://valtimo-snapshots.s3.eu-central-1.amazonaws.com/")
        content { includeGroupAndSubgroups("com.ritense") }
